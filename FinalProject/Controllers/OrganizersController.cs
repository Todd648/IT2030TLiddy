...
namespace FinalProject.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrganizerID,OrganizerEmail,OrganizerPhone")] Organizer organizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrganizerID,OrganizerEmail,OrganizerPhone")] Organizer organizer)
        {
            if (ModelState.IsValid)
            {
